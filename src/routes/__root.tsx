...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rasa — Modern Indian Kitchen & Bar" },
      { name: "description", content: "Rasa is a modern Indian kitchen serving heritage recipes reimagined with regional spices, wood-fire tandoor and small-batch cocktails." },
      { name: "author", content: "Rasa" },
      { property: "og:title", content: "Rasa — Modern Indian Kitchen & Bar" },
      { property: "og:description", content: "Heritage recipes, reimagined. Wood-fire tandoor, regional spice, small-batch cocktails." },
